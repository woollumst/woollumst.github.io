function About() {
    return (
        <div className="about">
            <h1>About Me</h1>
            <h2>Bio</h2>
            <p>Hi, I'm Toby Woollums, a passionate aspiring software developer working towards becoming a 
        **full-stack developer**. I have a strong foundation in **Java and JavaScript** and am 
        ...
        projects to improve my skills</p>
            ...
            <br />
            <h2>Future Goals</h2>
            <p>My goal is to land my first **software development role** while continuing to grow in 
        **React, full-stack development, and DevOps**. I'm eager to work on meaningful projects 
        and contribute to a dynamic engineering team.</p>
        </div>
    );
}
